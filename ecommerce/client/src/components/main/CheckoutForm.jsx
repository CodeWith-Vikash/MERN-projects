...
const CheckoutForm = () => {
  ...
  const clearCart = () => {
    axios
      .delete(`${baseurl}/api/cart/clear/${userdata._id}`)
      .then((result) => {
        console.log(result);
    ...
    <div className="bg-blue-500 flex justify-center items-center h-screen">
      {success ? (
        ...
        <form
          ...
          className="w-[300px] bg-white p-2 rounded-lg flex flex-col gap-2"
        >
          ...
          <button
            ...
            className="bg-green-500 text-white py-1 px-2 rounded w-fit"
          >

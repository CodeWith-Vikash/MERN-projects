  ...
  return (
    <div className='bg-gray-300 h-screen flex justify-center items-center'>
       <div className='flex flex-col gap-6 bg-white w-[300px] px-4 py-6 rounded-lg items-center shadow'>
         ...
         <input type="text" placeholder='Username' className='border-2 border-gray-400 rounded-lg px-2 py-1 text-lg outline-blue-600'/>
         ...
         <button type="submit" className='bg-green-600 text-white text-lg font-semibold rounded-lg py-2'>Signup</button>
         </form>
         <Link to='/login'>
